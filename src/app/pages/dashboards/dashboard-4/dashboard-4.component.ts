...
@Component({
  selector: 'page-dashboard-4',
  templateUrl: './dashboard-4.component.html',
  styleUrls: ['./dashboard-4.component.scss']
})
export class PageDashboard4Component extends BasePageComponent implements OnInit, OnDestroy {
      ...
      series: [
        {
          ...
          type: 'line',
          smooth: true,
          data: [190, 170, 150, 143, 138, 178, 194, 211, 234, 257, 241, 226],
          areaStyle: {}
        }
      ]
    };
      ...
      series: [
        {
          ...
          type: 'line',
          smooth: true,
          data: [70, 90, 110, 150, 170, 166, 170, 180, 170, 150, 140, 120],
          areaStyle: {}
        }
      ]
    };
